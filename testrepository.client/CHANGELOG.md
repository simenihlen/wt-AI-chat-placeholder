...
- Create Angular project with ng: `ng new testrepository.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`testrepository.client.esproj`).
