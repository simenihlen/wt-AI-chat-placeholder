...
public class DeepSeekVendorServiceImpl : IGptVendorService
{
    private readonly HttpClient _httpClient;
    private readonly string _apiKey;

    public string VendorName => "DeepSeek R1";

    public DeepSeekVendorServiceImpl(IConfiguration configuration)
    {
