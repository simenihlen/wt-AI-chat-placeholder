...
public class ClaudeVendorServiceImpl : IGptVendorService
{
    private readonly Anthropic _anthropic;

    public string VendorName => "Claude 3.7 Sonnet";

    public ClaudeVendorServiceImpl(IConfiguration config)
    {
    ...
    public async Task<string> GetResponseAsync(List<ChatMessageRequestObject> messages)
    {
        ...
        {
            Model = Claudia.Models.Claude3_7Sonnet,
            MaxTokens = 300,
            Temperature = 0.8,
