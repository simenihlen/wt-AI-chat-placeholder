...
public class OpenAIVendorServiceImpl2 : IGptVendorService
{
    private readonly HttpClient _httpClient;
    private readonly string _apiKey;

    public string VendorName => "OpenAI 3.5 Turbo";

    public OpenAIVendorServiceImpl2(IConfiguration configuration)
    {
