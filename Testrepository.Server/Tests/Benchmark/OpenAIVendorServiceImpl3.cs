...
public class OpenAIVendorServiceImpl3 : IGptVendorService
{
    private readonly HttpClient _httpClient;
    private readonly string _apiKey;

    public string VendorName => "OpenAI 4o mini";

    public OpenAIVendorServiceImpl3(IConfiguration configuration)
    {
