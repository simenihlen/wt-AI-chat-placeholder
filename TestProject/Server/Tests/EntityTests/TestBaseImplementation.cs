...
{
    public class TestBaseImplementation : TestBase, IClassFixture<CustomWebApplicationFactory<Program>>
    {
        DatabaseContext _context;

        public TestBaseImplementation(CustomWebApplicationFactory<Program> factory, ITestOutputHelper logger) : base(factory, logger)
        {
